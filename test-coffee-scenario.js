// Тестовый скрипт для проверки сценария открытия кофейни
// Этот скрипт имитирует последовательность действий пользователя

const { MockAgentService } = require('./dist/assets/index-4be997fa.js');

// Создаем экземпляр сервиса агента
...
async function testCoffeeScenario() {
  console.log('🧪 Начинаем тестирование сценария открытия кофейни...\n');
  ...
  try {
    ...
    console.log('✅ Metadata:', response2.metadata?.messageType);
    console.log('');
    ...
    console.log('✅ Metadata:', response3.metadata?.messageType);
    console.log('');
    ...
    console.log('✅ Metadata:', response5.metadata?.messageType);
    console.log('');
    ...
    console.log('✅ Metadata:', response7.metadata?.messageType);
    console.log('');
    ...
    console.log('✅ Metadata:', response8.metadata?.messageType);
    console.log('');
    ...
    console.log('✅ Metadata:', response9.metadata?.messageType);
    console.log('');
    ...
    console.log('✅ Metadata:', response10.metadata?.messageType);
    console.log('');
    ...
    console.log('✅ Metadata:', response11.metadata?.messageType);
    console.log('');
