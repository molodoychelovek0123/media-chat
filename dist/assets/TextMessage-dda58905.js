import{r as d,j as t}from"./index-5e568077.js";const g=d.memo(({message:n,theme:r})=>{const m=d.useCallback(c=>{navigator.clipboard.writeText(c).then(()=>{console.log("Код скопирован в буфер обмена")})},[]),x=d.useCallback(c=>{const a=c.split(`
